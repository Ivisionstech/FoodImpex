        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-sm-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="ajax-form" action="{{ route('general-transactions.bank-withdraw.store') }}"
                            method="POST">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="amount">Withdrawal Amount <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control @error('amount') is-invalid @enderror"
                                        id="amount" name="amount" step="0.01" min="0.01" required />
                                    <div class="invalid-feedback" id="amount-error"></div>
                                    <small class="text-muted">Available balance will be shown after selecting bank</small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">Cash balance will increase after withdrawal</small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="3" placeholder="Enter description for this withdrawal"></textarea>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-warning">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong>Cash After Withdrawal:</strong> <span id="cash-after">PKR
                                                    {{ $cash ? number_format($cash->balance, 2) : '0.00' }}</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function validateAmount() {
                const amount = parseFloat($('#amount').val()) || 0;
                const bankBalance = parseFloat($('#bank_id').find('option:selected').data('balance')) || 0;

                if (amount > bankBalance) {
                    $('#amount').addClass('is-invalid');
                    $('#amount-error').text('Amount cannot exceed bank balance');
                } else {
