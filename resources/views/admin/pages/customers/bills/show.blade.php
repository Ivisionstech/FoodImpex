    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('customers.bills.download', $bill->uuid) }}" class="btn btn-primary">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 text-md-end">
                        ...
                        {{-- <p class="mb-1"><strong>Status:</strong>
                            <span
                                class="badge bg-{{ $bill->status === 'pending' ? 'warning' : ($bill->status === 'paid' ? 'success' : 'info') }}">
                                {{ ucfirst($bill->status) }}
                            </span>
                        </p> --}}
                    </div>
                        ...
                        <tbody>
                            @foreach ($bill->billProducts as $billProduct)
                                <tr>
                                    ...
                                    <td>{{ $billProduct->quantity }} Qty.</td>
                                    <td>PKR {{ number_format($billProduct->price, 2) }}</td>
                                    <td>PKR {{ number_format($billProduct->total, 2) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
