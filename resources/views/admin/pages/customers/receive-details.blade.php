...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            ...
            <a href="{{ route('customers.view', $transaction->customer->uuid) }}">{{ $transaction->customer->name }}</a>
            /
            Payment
            Details
        </h4>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                {{-- <div>
                    <a href="{{ route('vendors.view', $transaction->customer->uuid) }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <p class="mb-1"><strong>Amount:</strong> PKR {{ $transaction->amount }}</p>
                        <p class="mb-1"><strong>Balance:</strong> PKR {{ $transaction->current_balance }}</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            @foreach ($transaction->transactionImages as $image)
                                <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($bill->transaction)
                            <p class="mb-1"><strong>Transaction Date:</strong>
                                {{ $bill->transaction->date }}</p>
                            <p class="mb-1"><strong>Current Balance:</strong>
                                {{ number_format($bill->transaction->current_balance, 2) }}</p>
                        @endif
                    </div>
